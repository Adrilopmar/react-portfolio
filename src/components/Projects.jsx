  ...
  return (
    <>
      {data.map((el) => (
        <div
          key={el.id}
          className="max-w-sm rounded  mx-auto project-card relative"
        >
          ...
          <div className="px-6 pt-4 justify-between flex gap-5">
            <Link to={el.website} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-2/4 text-center">
              Read more
            </Link>
